    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            IEnumerable<Emp> result = from emp in Emps 
                where emp.Job =="Backend Programmer" select emp;

            IEnumerable<Emp> result2 = Emps.Where(emp => emp.Job == "Backend Programmer");
        ...
        {
            IEnumerable<Emp> result = Emps.Where(emp => emp.Job == "Backend Programmer" && emp.Salary > 1000).OrderByDescending(emp => emp.Ename);
            return result;
        }
        ...
        public static IEnumerable<Dept> Task15()
        {
            IEnumerable<Dept> result = Emps
                ...
                .Select(group => new Dept { Dname = group.Key, Loc = "", Deptno = 0 });
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = from emp in Emps
                from dept in Depts
                select dept;
            return result;
        }
